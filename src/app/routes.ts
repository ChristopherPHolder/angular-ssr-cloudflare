...
export const ROUTES: Routes = [
  {
    ...
    loadComponent: () => import('./pages/movie-list-page/movie-list-page.component'),
  },
  {
    path: 'detail/movie/:identifier',
    loadComponent: () => import('./pages/movie-detail-page/movie-detail-page.component'),
  },
  {
  ...
  },
  {
    ...
    loadComponent: () => import('./pages/person-detail-page/person-detail-page.component'),
  },
  {
    path: 'account',
    loadChildren: () => import('./pages/account-feature/account-feature-page.routes'),
  },
  {
    path: 'page-not-found',
